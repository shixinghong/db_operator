...
import (
	...
	"github.com/hongshixing/db_operator/pkg/client/clientset/versioned/scheme"
...
// ApiV1Client is used to interact with features provided by the api.myit.fun group.
type ApiV1Client struct {
	restClient rest.Interface
}

func (c *ApiV1Client) DbConfigs(namespace string) DbConfigInterface {
	return newDbConfigs(c, namespace)
}
